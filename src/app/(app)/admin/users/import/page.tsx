  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        description="Загрузка справочника сотрудников из файла .xlsx (§8). Сопоставление по табельному номеру: совпавшие записи обновляются, новые — создаются. Учётные записи для входа импорт не создаёт."
        action={
