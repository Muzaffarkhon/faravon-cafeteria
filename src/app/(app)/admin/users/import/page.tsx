  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        description="Загрузка справочника сотрудников из файла .xlsx. Сопоставление по ФИО (без учёта регистра): совпавшие записи обновляются, новые — создаются. Система автоматически генерирует уникальные логины и создаёт учётные записи для входа."
        action={
